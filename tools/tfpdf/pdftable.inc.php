...
class PDFTable extends /*FPDF*/PDF_ImageAlpha{
...
function Header(){
	...
	//$this->AddFont($defFont,'','ARIALUNI.TTF',true);
	$this->AddFont($defFont.'B','','ARIALUNI.TTF',true);
	
	*/
	$this->SetFont($defFont,'',20);
	$this->Image(_TAS_THEME_DIR_. "/img/logo_pdf.png",140,15,60);
	$this->htmltable("<table width=190>
    ...
    $this->Image(_TAS_THEME_DIR_. "/img/linep.png",10,$this->y,190);
		/*
	if ($this->headerTable){
...
function Footer(){
    ...
    $this->Image(_TAS_THEME_DIR_. "/img/linep.png",10,$this->y,190);
	$this->Ln(1);
	$this->Image(_TAS_THEME_DIR_. "/img/bottom_logo_pdf.png",12,$this->y+2,20);
	$this->x = 35;
	//parent::SetLeftMargin(35);
	//$this->SetLeftMargin(35);
	$this->htmltable("<table width=90>
	    <tr><td size=10>TAS Agent / TAS Co.Ltd<br>TEL +81-3-5565-5850</td></tr></table>", 0);
