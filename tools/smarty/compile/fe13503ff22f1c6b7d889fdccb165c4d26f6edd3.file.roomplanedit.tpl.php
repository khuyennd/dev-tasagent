<?php /* Smarty version Smarty-3.0.7, created on 2015-09-28 03:57:20
         compiled from "/var/www/html/tas-agent/themes/default/roomplanedit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2539419585608baa0d3d644-04628910%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fe13503ff22f1c6b7d889fdccb165c4d26f6edd3' => 
    array (
      0 => '/var/www/html/tas-agent/themes/default/roomplanedit.tpl',
      1 => 1443412331,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2539419585608baa0d3d644-04628910',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/tas-agent/tools/smarty/plugins/modifier.regex_replace.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/tas-agent/tools/smarty/plugins/modifier.date_format.php';
?>
            <!-- right content start -->
...
" ';
 ...
 == type)
                ...
                if (<?php echo $_smarty_tpl->getVariable('isHotel')->value;?>
 == 0) {
                    mainTable += '    <td width="10%" class="txtcenter">';
...
');
        	...
        	$("#add_btn").click(function(){
        		addRoomPlan(0, 1, '', 1, 1, 1, 30, '', 1, 1, 0, '<?php echo $_smarty_tpl->getVariable('today')->value;?>
