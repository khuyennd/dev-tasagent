<?php /* Smarty version Smarty-3.0.7, created on 2015-09-07 16:05:39
         compiled from "/var/www/tas/themes/default/common/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:77940909755ed5363045560-44982806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '463b9186f01f8e9d5667ebe4e90b4f18b29a828c' => 
    array (
      0 => '/var/www/tas/themes/default/common/header.tpl',
      1 => 1441616736,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77940909755ed5363045560-44982806',
  'function' => 
  array (
  ),
...
<?php echo $_smarty_tpl->getVariable('cookie')->value->Name;?>
                ...
                <?php }?>
                &nbsp;|&nbsp;
                <a href="/tas/index.php"><?php echo smartyTranslate(array('s'=>'Top Page'),$_smarty_tpl);?>
</a><span>&nbsp;|&nbsp;</span>
                <a href="/tas/index.php?mylogout"><?php echo smartyTranslate(array('s'=>'Sign Out'),$_smarty_tpl);?>
</a>
				<?php if ($_smarty_tpl->getVariable('cookie')->value->OldLoginUserName!=null){?>
				&nbsp;|&nbsp;
                <a href="/tas/login.php?changeback=1"><?php echo smartyTranslate(array('s'=>'Change Back'),$_smarty_tpl);?>
</a>
                <?php }?>
            </div>  
    	</div>
