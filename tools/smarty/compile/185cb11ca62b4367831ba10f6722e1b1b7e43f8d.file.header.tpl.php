<?php /* Smarty version Smarty-3.0.7, created on 2015-09-16 04:10:53
         compiled from "/var/www/html/tas-agent/themes/default/common/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156241497955f8ebcd764019-95056551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '185cb11ca62b4367831ba10f6722e1b1b7e43f8d' => 
    array (
      0 => '/var/www/html/tas-agent/themes/default/common/header.tpl',
      1 => 1442376646,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156241497955f8ebcd764019-95056551',
  'function' => 
  array (
  ),
...
<?php echo $_smarty_tpl->getVariable('cookie')->value->Name;?>
                ...
                <?php }?>
                &nbsp;|&nbsp;
                <a href="/tas-agent/index.php"><?php echo smartyTranslate(array('s'=>'Top Page'),$_smarty_tpl);?>
</a><span>&nbsp;|&nbsp;</span>
                <a href="/tas-agent/index.php?mylogout"><?php echo smartyTranslate(array('s'=>'Sign Out'),$_smarty_tpl);?>
</a>
				<?php if ($_smarty_tpl->getVariable('cookie')->value->OldLoginUserName!=null){?>
				&nbsp;|&nbsp;
                <a href="/tas-agent/login.php?changeback=1"><?php echo smartyTranslate(array('s'=>'Change Back'),$_smarty_tpl);?>
</a>
                <?php }?>
            </div>  
    	</div>
