<?php /* Smarty version Smarty-3.0.7, created on 2015-09-24 03:40:30
         compiled from "/var/www/html/tas-agent/themes/default/booking_order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36230412560370ae296ef9-54753934%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '213b99128f9166cf2c34bb881ad3c8af1b77f7f3' => 
    array (
      0 => '/var/www/html/tas-agent/themes/default/booking_order.tpl',
      1 => 1443065929,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '36230412560370ae296ef9-54753934',
  'function' => 
  array (
  ),
	...
	function onsubmit_booking_confirm()
	{
		...
		for(i = 0; i < ids_obj.length; i++)
		{
            ...
            for (var j = 0; j < input_fnames_objs.length; j++)
            {
                ...
                if(check_text(fname,"<?php echo smartyTranslate(array('s'=>'We can accept only alphabet characters'),$_smarty_tpl);?>
")==false){
                    return false;
                }
                if(check_text(gname,"<?php echo smartyTranslate(array('s'=>'We can accept only alphabet characters'),$_smarty_tpl);?>
")==false){
                    return false;
                }
            }
...
");
        ...
        /*if(check_text($("#contact_name").val(),"<?php echo smartyTranslate(array('s'=>'We can accept only alphabet characters'),$_smarty_tpl);?>
")==false){
            return false;
        }*/
