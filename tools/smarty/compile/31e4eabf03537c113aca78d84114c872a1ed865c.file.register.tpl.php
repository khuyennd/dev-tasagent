<?php /* Smarty version Smarty-3.0.7, created on 2015-09-28 03:56:10
         compiled from "/var/www/html/tas-agent/themes/default/register.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15779188375608ba5a76c059-03030389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31e4eabf03537c113aca78d84114c872a1ed865c' => 
    array (
      0 => '/var/www/html/tas-agent/themes/default/register.tpl',
      1 => 1443412291,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15779188375608ba5a76c059-03030389',
  'function' => 
  array (
  ),
...
<?php $_smarty_tpl->tpl_vars["roleid"] = new Smarty_variable(($_smarty_tpl->getVariable('cookie')->value->RoleID), null, null);?>
<?php if ($_GET['mid']>0&&($_smarty_tpl->getVariable('roleid')->value>3||$_smarty_tpl->getVariable('roleid')->value==1)){?>
...
<?php }?> 
            ...
            <input type="hidden" name="nohotel" value="<?php echo $_GET['nohotel'];?>
" />
            <input type="hidden" name="hotelid" value="<?php echo $_GET['hid'];?>
" />
