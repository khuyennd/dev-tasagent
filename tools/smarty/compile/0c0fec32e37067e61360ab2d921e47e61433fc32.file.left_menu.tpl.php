<?php /* Smarty version Smarty-3.0.7, created on 2015-09-24 08:28:18
         compiled from "/var/www/html/tas-agent/themes/default/./common/left_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9669086675603b422a882f4-93893061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c0fec32e37067e61360ab2d921e47e61433fc32' => 
    array (
      0 => '/var/www/html/tas-agent/themes/default/./common/left_menu.tpl',
      1 => 1443083167,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9669086675603b422a882f4-93893061',
  'function' => 
  array (
  ),
...
<?php if (strstr($_smarty_tpl->getVariable('request_uri')->value,"hoteldetail")||strstr($_smarty_tpl->getVariable('request_uri')->value,"hotelpage")){?>
    <?php $_smarty_tpl->tpl_vars["mid"] = new Smarty_variable(($_GET['mid']), null, null);?>
    <?php $_smarty_tpl->tpl_vars['hotel'] = new Smarty_variable(HotelDetail::getHotelDescription($_smarty_tpl->getVariable('mid')->value), null, null);?>
    <?php $_smarty_tpl->tpl_vars['cityName'] = new Smarty_variable(HotelDetail::getCityName($_smarty_tpl->getVariable('hotel')->value['HotelCity']), null, null);?>
<?php }else{ ?>
    <?php $_smarty_tpl->tpl_vars['cityName'] = new Smarty_variable('Tokyo', null, null);?>
<?php }?>
<!-- left navigation end -->
...
<script type="text/javascript">
    $(document).ready(function() {
        var example3 = $("#weather").flatWeatherPlugin({
            location: " <?php echo $_smarty_tpl->getVariable('cityName')->value;?>
",
            country: "Japan",
            api: "yahoo",
