...
var gcCalBG="#fcfcfc";	// the background color of the outer calendar panel.
...
var gcCalFrame="#f4f4f4";	// the background color of the inner table, showing as a frame.
...
var gsNavPrev="<IMG src='ico_prev_ca.gif' id='navPrev' class='MonthNav' style='cursor:pointer;' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG src='ico_next_ca.gif' id='navNext' class='MonthNav' style='cursor:pointer;' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcCellBG="#fcfcfc";	// default background color of the cells. Use "" for transparent!!!
...
var gcWorkday="#666666";	// Workday font color
//var gcSat="black";	// Saturday font color
var gcSat="#7595ff";	// Saturday font color
//var gcSatBG="#99ccff";	// Saturday background color
var gcSatBG="#fcfcfc";	// Saturday background color
//var gcSun="black";	// Sunday font color
var gcSun="#ff6464";	// Sunday font color
//var gcSunBG="#99ccff";	// Sunday background color
var gcSunBG="#fcfcfc";	// Sunday background color
...
var gcFGSelected="#666666";	// the font color for the selected date
//var gcBGSelected="#DB5141";	// the background color for the selected date
var gcBGSelected="#00ffff";	// the background color for the selected date
