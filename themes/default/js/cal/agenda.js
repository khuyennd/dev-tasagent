...
/*
	if (m==1&&d==1)
		r=[" 1.1, "+y+" \n 설날축하! ",gsAction,"skyblue","red"];
	else if (m==12&&d==25)
		r=[" 12.25, "+y+" \n 성탄절축하! ",gsAction,"skyblue","red"];
	else if (m==2&&d==14)
		r=[" 2.14, "+y+" \n 왈레찐축하！ ",gsAction,"skyblue","red"];
	else if (m==3&&d==8)
		r=[" 3.8, "+y+" \n 부녀절축하！ ",gsAction,"skyblue","red"];
	else if (m==4&&d==1)
		r=[" 4.1, "+y+" \n 만우절축하！ ",gsAction,"skyblue","red"];
	else if (m==4&&d==5)
		r=[" 4.5, "+y+" \n 청명축하！ ",gsAction,"skyblue","red"];
	else if (m==5&&d==1)
		r=[" 5.1, "+y+" \n 로동절축하！ ",gsAction,"skyblue","red"];
	else if (m==6&&d==1)
		r=[" 6.1, "+y+" \n 어린이절축하！ ",gsAction,"skyblue","red"];
		*/
/*
	else if (m==10&&d==1)
		r=[" 10.1, "+y+" \n 祝贺国庆节！ ",gsAction,"skyblue","red"];
	else if (m==5&&d==4)
		r=[" 5.4, "+y+" \n 祝贺青年节！ ",gsAction,"skyblue","red"];
	else if (m==8&&d==1)
		r=[" 8.1, "+y+" \n 祝贺建军节！ ",gsAction,"skyblue","red"];
	else if (m==9&&d==1)
		r=[" 9.1, "+y+" \n 祝贺教师节！ ",gsAction,"skyblue","red"];
	else if (m==5&&d<15) {
		var date=fGetDateByDOW(y,5,2,0);	// Martin Luther King, Jr. Day is the 3rd Monday of Jan
		if (d==date) r=[" 5."+d+", "+y+" \n 祝贺母亲节！ ",gsAction,"skyblue","red"];
	}
	else if (m==6&&d<20) {
		var date=fGetDateByDOW(y,6,3,0);	// President's Day is the 3rd Monday of Feb
		if (d==date) r=[" 6."+d+", "+y+" \n 祝贺父亲节！ ",gsAction,"skyblue","red"];
	}
*/
/*		
	else if (m==1&&d<25) {
